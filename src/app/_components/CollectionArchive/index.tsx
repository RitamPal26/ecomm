...
export const CollectionArchive: React.FC<Props> = props => {
  ...
  }, [page, categoryFilters, relationTo, onResultChange, sort, limit, populateBy, categories])
      ...
      <Fragment>
        ...
        <div className={classes.grid}>
          {results.docs?.map((result, index) => {
            return <Card key={index} relationTo="products" doc={result as Product} showCategories />
          })}
        </div>
